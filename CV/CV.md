...
<!-- <img src="me.jpg" alt="焦元" width="80" style="float:right; margin-right:25px;"> -->

- **焦元** / 男 / 2003 / 甘肃敦煌
- 教育经历：成都理工大学 / 环境科学与工程 / 2021-2025 / 本科 / CET-4
- 联系方式：17344338724 / imjiaoyuan@gmail.com
- GitHub：imjiaoyuan / 博客：https://yuanj.top
...
- 2025.01-2025.06 **四川科伦博泰生物医药公司-转化医学中心-生物信息实习生**
    ...
    - 使用 SQLite 开发医学数据库并通过 Pyplot 开发配套的可视化应用
...
- 2022.12-2023.09 **黑麦草重金属胁迫响应基因的筛选与生物信息学分析-项目负责人**
...
- 长期使用 Debian、Arch、Ubuntu 等 Linux 桌面发行版
- 课余时间使用 Cursor、DeepSeek API 等 AI 代码编辑器进行开发
    - bioinformatics_toolbox：通过 HTML/CSS/js 来实现多种生信数据的可视化
    - RSS Reader：使用 GitHub Actions 与 Python 实现 RSS 文章抓取